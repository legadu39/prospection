...
**371 tests existent** — unit (218) + intégration TikTok (88) + intégration Reddit (65). Règles à respecter :
...
- Le module Reddit `partner_hunter.py` importe `PhysicsHumanizer` qui n'existe pas — stub via `sys.modules`
